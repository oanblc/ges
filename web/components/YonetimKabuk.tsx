...
const IKONLAR: Record<string, React.ReactNode> = {
  ...
  uyetalep: (<svg width="18" height="18" viewBox="0 0 24 24" {...cizgi}><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="4" /><path d="M4.9 4.9l4.2 4.2M14.9 14.9l4.2 4.2M14.9 9.1l4.2-4.2M4.9 19.1l4.2-4.2" /></svg>),
...
const SEKMELER: Array<[string, string, string]> = [
  ...
  ["/yonetim/uye-talepleri", "Üye Talepleri", "uyetalep"],
