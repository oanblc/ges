...
/** Mevzuat AI araması — asistan servisine düz JSON proxy'si. */
export async function POST(req: Request) {
  ...
  let res: Response;
  try {
    res = await fetch(`${SERVIS}/mevzuat-soru`, {
      method: "POST",
    ...
    return Response.json(
      { hata: "Arama servisi şu an çalışmıyor; lütfen daha sonra deneyin." },
      { status: 503 },
    );
  }
